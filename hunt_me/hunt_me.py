...
"""
hunt_me: Find Usernames Across The Social Networks Module
...
class hunt_meFuturesSession(FuturesSession):
    def request(self, method, url, hooks={}, *args, **kwargs):
        ...
        return super(hunt_meFuturesSession, self).request(method,
                                                           url,
                                                           hooks=hooks,
                                                           *args, **kwargs)
...
def hunt_me(username, site_data, query_notify,
             tor=False, unique_tor=False,
             proxy=None, timeout=None):
    """Run hunt_me Analysis.
    ...
    session = hunt_meFuturesSession(max_workers=max_workers,
