...
More
sherlock/sherlock/tests/base.py /
@dannysepler
dannysepler Clean out unused imports
Latest commit 3fa85c1 on May 23, 2020
History
2 contributors
@hoadlck
@dannysepler
228 lines (186 sloc) 8.4 KB
"""Sherlock Base Tests
...
class hunt_meBaseTest(unittest.TestCase):
    def setUp(self):
        """hunt_me Base Test Setup.
        Does common setup tasks for base hunt_me tests.
        Keyword Arguments:
        self                   -- This object.
        Return Value:
        N/A.
